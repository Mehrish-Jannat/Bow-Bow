function preload(){
  ...
  H1 = loadImage("Bow1-removebg-preview.png")
  H2 = loadImage("Bow2-removebg-preview.png")
  H3 = loadImage("Bow3-removebg-preview.png")
  H4 = loadImage("Bow4-removebg-preview.png")
  H5 = loadImage("Bow5-removebg-preview.png")
  H6= loadImage("Bow6-removebg-preview.png")
  H7 = loadImage("Bow7-removebg-preview.png")
}
...
function setup() {
  ...
  Bow1 = createSprite(100,100, 100,100)
  Bow1.addImage(H1)
  Bow1.scale = 0.2
  Bow1.debug = false

  Bow2 = createSprite(250,100, 100,100)
  Bow2.addImage(H2)
  Bow2.scale = 0.2
  Bow2.debug = false

  Bow3 = createSprite(400,100, 100,100)
  Bow3.addImage(H3)
  Bow3.scale = 0.2
  Bow3.debug = false

  Bow4 = createSprite(850,100, 100,100)
  Bow4.addImage(H4)
  Bow4.scale = 0.2
  Bow4.debug = false

  Bow5 = createSprite(1000,100, 100,100)
  Bow5.addImage(H5)
  Bow5.scale = 0.2
  Bow5.debug = false

  Bow6 = createSprite(1150,100, 100,100)
  Bow6.addImage(H6)
  Bow6.scale = 0.2
  Bow6.debug = false

  SV = createSprite(width/2-35,height/2-85)
